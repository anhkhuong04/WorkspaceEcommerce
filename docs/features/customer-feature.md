...
- _Lưu ý:_ Giỏ hàng có thể được lưu trữ qua Session đối với khách vãng lai (Guest) hoặc gắn với tài khoản nếu đã đăng nhập.
...
4. **Wishlist (Sản phẩm yêu thích):** Không có chức năng lưu lại sản phẩm để mua sau.
5. **Gợi ý sản phẩm thông minh:** Không có các thuật toán gợi ý "Sản phẩm liên quan" hoặc "Khách hàng khác cũng mua" dựa trên AI.
6. **Khách hàng thân thiết:** Không có tích điểm, hạng thẻ thành viên hay chương trình giới thiệu (Referral).
