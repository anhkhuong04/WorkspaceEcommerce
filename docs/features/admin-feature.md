...
- _Lưu ý:_ Hệ thống hiện tại sử dụng một cấp độ quyền admin chung, chưa phân chia vai trò (Role-based access control) phức tạp.
...
4. **Tích hợp vận chuyển:** Chưa tích hợp trực tiếp với các đơn vị vận chuyển (GHN, GHTK, Viettel Post) để tự động đẩy đơn và in vận đơn. Admin phải cập nhật trạng thái giao hàng thủ công.
5. **Báo cáo và Phân tích:** Dashboard chỉ cung cấp các con số cơ bản. Thiếu các báo cáo chuyên sâu về doanh thu theo thời gian, phân tích lợi nhuận, cohort analysis.
